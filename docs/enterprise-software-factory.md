...
8. 72B/72I: estimation and roadmap planner.
9. Later: safe scaffold planner.
10. Later: scaffold generator only after approval gates.

Source code, catalogs, generators, scripts, database schemas, dashboard UI, and
