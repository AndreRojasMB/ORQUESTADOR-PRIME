...
richer family-specific templates, reporting-to-planning integration, or
process-to-blueprint integration.
...
14. Later: safe scaffold planner.
15. Later: scaffold generator only after approval gates.
